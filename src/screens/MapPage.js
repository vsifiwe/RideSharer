      ...
      <View style={styles.container}>
        <MapView
          ...
          {this.state.rider_location && (
            <Marker pinColor="#25a25a" coordinate={this.state.rider_location}>
              <Callout>
  ...
  shareRide = username => {
    axios
      ...
      .then(response => {
        ...
        Alert.alert('Ride was shared!', 'Wait until someone makes a request.');
      })
      .catch(error => {
    ...
    this.watchId = navigator.geolocation.watchPosition(
      position => {
        ...
        if (this.journey_id && this.hiker) {
          ...
          this.users_channel.trigger(
            'client-rider-locationchange',
            location_data,
          );
          ...
          let diff_in_meters = getLatLonDiffInMeters(
            latitude,
            longitude,
            this.hiker.origin_coords.latitude,
            this.hiker.origin_coords.longitude,
          );
            ...
            this.riders_channel.bind('client-rider-accepted', rider_data => {
              ...
              this.riders_channel.bind('client-rider-locationchange', data => {
                ...
                let diff_in_meters = getLatLonDiffInMeters(
                  data.lat,
                  data.lon,
                  hikers_origin.latitude,
                  hikers_origin.longitude,
                );
